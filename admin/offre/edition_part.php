		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-12">
					<form name="formulaire" id="formulaire" class="form-horizontal" method="POST"  action="../formprocess_part.php">
						...
						<div id="div_liste_image">
							...
							if ( !empty( $liste_image ) ) {
								...
								foreach( $liste_image as $_image ) {
				            		...
				            		echo "	<img src='/particuliers/photos/offre/vignette/" . $_image[ "fichier" ] . "' width='230' style='max-width:230px;'></a><br>\n";
