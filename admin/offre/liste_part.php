<?php include_once ( $_SERVER['DOCUMENT_ROOT'] . "/admin/inc-auth-granted.php" );?>
<?php include_once ( $_SERVER['DOCUMENT_ROOT'] . "/admin/classes/utils.php" );?>
<?php
...
<html class="no-js" lang="en">
	<head>
        <?php include_once $_SERVER['DOCUMENT_ROOT'] . "/admin/inc-meta.php";?>
	</head>
	
	<body>
    <?php require_once $_SERVER['DOCUMENT_ROOT'] . "/admin/inc-menu.php";?>
						...
						<tbody>
							...
							if (!empty($result)) {
								...
								<tr class="<?php if ($i%2!=0) echo 'info'?>">
									...
									<td><a href="./edition_part.php?id=<?=$value[ "num_offre" ]?>"><img src="../img/modif.png" width="30" alt="Modifier" ></a></td>
									<td>
