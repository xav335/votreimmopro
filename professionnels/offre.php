...
<html class="no-js" lang="fr">
	...
	<body>
		...
		<?
		// ---- Header de la page ------------------ //
		include_once( $_SERVER['DOCUMENT_ROOT'] . "/professionnels/include/header.php" );
		?>
		...
		<div class="row offre">
			...
			<div class="large-6 columns">
				<a href="/professionnels/photos/offre/grande<?=$image_defaut[ "fichier" ]?>" class="fancybox photo-principale" rel="offre"><img src="/professionnels/photos/offre/normale<?=$image_defaut[ "fichier" ]?>" alt="" /></a>
						...
						if ( !empty( $liste_image ) ) :
							foreach ( $liste_image as $_image ) : ?> 
								<li class="swiper-slide">
								    <a href="/professionnels/photos/offre/grande<?php echo $_image[ "fichier" ] ?>" class="fancybox" rel="offre">
								        <img src="/professionnels/photos/offre/vignette<?php echo $_image[ "fichier" ] ?>" alt='' /></a>
								</li>
					  <?php endforeach;
						endif;?>
					</ul>
			...
			<div class="large-6 columns">
				...
				if ( $fichier_pdf != '' ) {
					...
					echo "	<a href='/professionnels/fichier/pdf" . $fichier_pdf . "' target='_blank'><img src='/professionnels/img/pdf.png' /></a>\n";
					echo "</p>\n";
				}
				// ----------------------------------- //
				?>
		...
		<?
		// ---- Footer de la page ------------------ //
		include_once( $_SERVER['DOCUMENT_ROOT'] . "/professionnels/include/footer.php" );
		?>
